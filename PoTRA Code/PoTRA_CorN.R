...
if (length(args)==0) {
  ...
  # default output file
  args[7] = "Results_CorN.txt"
}

## Usage: Rscript mydata genelist Num.sample.normal Num.sample.case Pathway.database PR.quantile Results_CorN.txt
...
PoTRA.corN <- function(args[1], args[2], args[3], args[4], args[5], args[6]) {
